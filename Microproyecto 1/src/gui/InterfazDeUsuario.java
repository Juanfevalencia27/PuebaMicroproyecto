...
public class InterfazDeUsuario extends JFrame {
	...
	public InterfazDeUsuario() {
		...
		JLabel bienvenida = new JLabel(
				"<html><center><font size=6><center>Bienvenidos a</center></font><font size=7><center>AIR FARE</center></font></center></html>");
		JLabel L1 = new JLabel("Medida cuarto (m^2): ");
		L1.setToolTipText("<html>Es la calificación del estado actual que tiene el <br> componente a evaluar, en este caso el ambiental. [0,1]</html>");
		JLabel L2 = new JLabel("Cantidad personas: ");
		L2.setToolTipText("<html>Es la calificación de que tan propenso <br> es el estatus a cambiar. [0,1]</html>");
		JLabel L3 = new JLabel("Temperatura: ");
		L3.setToolTipText("<html>Es la calificación de los métodos de respuesta que se <br> tienen para llevar el nivel de presión a un punto donde <br> se garantice el mejor nivel de estatus. [0,1]</html>");
		...
		B1.addActionListener(new OyenteBoton(T1, T2, T3, TA1));
